...
public class WeightRegimine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_regimine);
    ...
    private TableRow addRow(String Exercise, int Min, int Sec) {
        ...
        if (Sec < 10) {
            TimeText.setText(Min + "x0" + Sec);
        }
        else TimeText.setText(Min + "x" + Sec);
